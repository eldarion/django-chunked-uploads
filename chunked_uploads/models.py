...
if STORAGE_PATH:
    ...
    storage_path = lambda obj, fname: os.path.join("chunked_uploads", u'%s' % obj.uuid, fname)
...
if CHUNKS_STORAGE_PATH:
    ...
    chunks_storage_path = lambda obj, fname: os.path.join("chunked_uploads", u'%s' % obj.upload.uuid, "chunks", "chunk")
...
class Upload(models.Model):
    ...
    def stitch_chunks(self):
        ...
        url = os.path.basename(fname.replace(".tmp", ""))
